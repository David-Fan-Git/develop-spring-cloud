package com.develop.mvp.pk.module.infra.service.codegen;
...
import com.develop.mvp.pk.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
...
import com.develop.mvp.pk.module.infra.service.codegen.inner.CodegenBuilder;
import com.develop.mvp.pk.module.infra.service.codegen.inner.CodegenEngine;
import com.develop.mvp.pk.module.infra.service.db.DataSourceConfigService;
import com.develop.mvp.pk.module.infra.service.db.DatabaseTableService;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("David");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getComment()).thenReturn("David");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_yunai_02");
        when(tableInfo02.getComment()).thenReturn("David_02");
        ...
        assertEquals("David", result.get(0).getComment());
    }
