...
description: Use when modifying or reviewing the MemberUser/会员用户 aggregate in this repository, including requests such as “重构会员用户”, “迁移 MemberUserService 到 DDD”, “修改 MemberUserApi”, “修复会员手机号唯一性/密码编码/积分/登录记录”, or changes to member user domain, application, repository, API, DTO, mapper, or legacy service behavior.
