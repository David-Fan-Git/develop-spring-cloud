---
name: aggregate-root-tenant-validation
description: Use when modifying or reproducing the SaaS Tenant aggregate DDD refactor in the system module, especially when current code and aggregate documentation may diverge.
