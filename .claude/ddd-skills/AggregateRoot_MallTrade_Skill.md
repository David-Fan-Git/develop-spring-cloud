---
name: aggregateroot-mall-trade-skill
description: Use when refactoring or validating Mall Trade DDD code, trade order/cart/after-sale/brokerage/delivery/config flows, trade API contracts, order handlers, price calculators, trade jobs, and payment/refund integrations.
